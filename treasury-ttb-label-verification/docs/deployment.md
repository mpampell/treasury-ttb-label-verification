...
Live extraction requires `OPENAI_API_KEY`. If the key is missing or has no quota, the deployed app will show an analysis error instead of returning mock data.
