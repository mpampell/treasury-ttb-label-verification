...
4. Enter or paste the corresponding object from `sample-application-data.json` into the application comparison form.
5. Confirm the comparison updates and flags the intended match or mismatch.
